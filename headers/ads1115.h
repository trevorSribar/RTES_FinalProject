 ...
 *      Edited by Kenneth Alcineus to include generic header
 *      and pass in address for node pointer
 ***********************************************************************
...
extern int ads1115Setup (struct wiringPiNodeStruct **node, int pinBase, int i2cAddress) ;
